...
$DB->set_field('zoomattendance', 'status', 'closed', ['id' => $session->id]);
...
redirect(new moodle_url('/mod/zoomattendance/view.php', ['id' => $id]), get_string('register_closed', 'mod_zoomattendance'));
